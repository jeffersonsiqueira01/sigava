        ...
        <div class="row">
            <div class="col-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        @include('app.property.form.address')
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        @include('app.property.form.metric')
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        @include('app.property.form.rooms')
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        @include('app.property.form.maintenance')
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        @include('app.property.form.plus')
                    </div>
                </div>
            </div>
        </div>
